package com.zenzen.blan.common;
...
public class Paging {
	...
	// 전체 게시물의 개수
	// 3. int recordPerPage;
	// 한 페이지당 게시물 개수 (게시판마다 한 페이지에 표시할 목록의 개수를 다르게 설정하기 위해서 받아 온다.)
	// 4. int page;
	// 현재 페이지 번호
	...
	public static String getPaging(String path, int totalRecord, int recordPerPage, int page) {
		...
		/* ListCommand에서 필요하다. */
		// int beginRecord = 0;
		// 한 페이지에 표시되는 시작 게시물의 번호 int endRecord = 0;
		// 한 페이지에 표시되는 종료 게시물의 번호
		
		// 페이지 5개를 한 블록에 배치
		int pagePerBlock = 10; // 한 블록당 페이지 5개
